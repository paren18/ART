        ...
        <div class="mb-5">
            <div class="agent__card">
                <div class="small-info">
                    <div class="avatar" style="background-image: url(<?php if (!empty($agent['PHOTO_PATH']))
                    { echo $agent['PHOTO_PATH']; }
                    else
                    { echo '/local/components/agents/templates/.default/images/no-avatar.png'; } ?>);"></div>
                    <div class="info">
                ...
                <?php
                $isStarAgent = in_array($agent['ID'], $arResult['STAR_AGENTS']);
                ?>
